...
handleSearch(e){
 ...
 this.props.resetState(this.state.reset);
        ...
        <div className="container">
          <nav className="navbar navbar-default navbar-custom">
            ...
            <div className="navbar-header logo">
              ...
              <a href="index-2.html"><img className="logo" src={logo} /> </a>
            </div>
          ...
          <div className="top-search">
            ...
            <input type="text" placeholder="Search for a movie, TV Show or celebrity that you are looking for"  onChange={this.handleTermChange} />
