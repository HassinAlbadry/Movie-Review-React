...
constructor(props){
  ...
  this.loopThruStars=this.loopThruStars.bind(this);
}


loopThruStars(){
 let numberOfStars=Math.round(this.props.vote_average);

  const stars=[];
    
    for(let i=0;i<numberOfStars;i++){

       stars.push(<i className="ion-ios-star" />);
...
return stars;
  ...
  const loopThruTheStarsResult= this.loopThruStars();
            ...
            <div className="row ipad-width2">
              <div className="col-md-4 col-sm-12 col-xs-12">
                <div className="movie-img sticky-sb">
                  <img src={this.props.url+'w300'+this.props.img} width={150} height={100} />
              ...
              <div className="col-md-8 col-sm-12 col-xs-12">
                <div className="movie-single-ct main-content">
                  <h1 className="bd-hd" >{this.props.title} <span>{this.props.release_date}</span></h1>
                  ...
                  <div className="movie-rate">
                    <div className="rate">
                      ...
                      <p><span>{this.props.vote_average}</span> /10<br />
